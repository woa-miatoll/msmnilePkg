...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    /* RAM Entry: Base 0x0000000080000000	Size 0x000000003BB00000 */
    /* RAM Entry: Base 0x00000000C0000000	Size 0x00000001C0000000 */
    // Memory Map
    //--------------------- DDR  -----

    { "HYP"               , 0x80000000, 0x005D0000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "IPC SHM"           , 0x805D0000, 0x00020000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "RAM Partition"     , 0x805F0000, 0x00010000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "MPSS_EFS"          , 0x80600000, 0x00100000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "BOOT INFO"         , 0x80700000, 0x00100000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "RAM Partition"     , 0x80800000, 0x00060000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "AOP CMD DB"        , 0x80860000, 0x00020000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "RAM Partition"     , 0x80880000, 0x00004000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "XBL Log Buffer"    , 0x80884000, 0x00010000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "RAM Partition"     , 0x80894000, 0x0006C000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "SMEM"              , 0x80900000, 0x00200000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "TEE Reserved"      , 0x80B00000, 0x01900000, NoHob, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "TZApps Reserved"   , 0x82400000, 0x03A00000, NoHob, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "RAM Partition"     , 0x85E00000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "PIL Reserved"      , 0x86000000, 0x0D200000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN },
    { "RAM Partition"     , 0x93200000, 0x05700000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    { "DXE Heap"          , 0x98900000, 0x03300000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData,   WRITE_BACK_XN },
    ...
    { "DBI Dump"          , 0x9E400000, 0x00F00000, NoHob,  MMAP_IO, INITIALIZED, Reserv,   UNCACHED_UNBUFFERED_XN },
    { "RAM Partition"     , 0x9F300000, 0x00500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    ...
    { "RAM Partition"     , 0x9FFD0000, 0x00027000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
